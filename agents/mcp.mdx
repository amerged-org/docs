...
```
npm install --global https://ohmyho.st/releases/0.1.0-beta.28/ohmyhost-product-cli-0.1.0-beta.28.tgz https://ohmyho.st/releases/0.1.0-beta.28/ohmyhost-mcp-0.1.0-beta.28.tgz
ohmyhost login --json
```
