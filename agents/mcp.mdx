...
```
npm install --global https://ohmyho.st/releases/0.1.0-beta.26/ohmyhost-product-cli-0.1.0-beta.26.tgz https://ohmyho.st/releases/0.1.0-beta.26/ohmyhost-mcp-0.1.0-beta.26.tgz
ohmyhost login --json
```
