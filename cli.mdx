...
```
npm install --global https://ohmyho.st/releases/0.1.0-beta.25/ohmyhost-product-cli-0.1.0-beta.25.tgz
ohmyhost login --json
...
[Release manifest and checksums](https://ohmyho.st/releases/0.1.0-beta.25/manifest.json) · [MCP setup](/agents/mcp) · [API reference](https://ohmyho.st/api)
